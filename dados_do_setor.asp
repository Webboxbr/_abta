...
<head>
	...
	<meta name="description" content="A TV por Assinatura comprova seu crescimento em diversas pesquisas, gráficos e indicadores, principalmente nos últimos anos. Conheça os dados do setor." />
	<meta name="keywords" content="Dados ABTA, dados TV assinatura, dados TV cabo, números TV assinatura, números TV cabo, pesquisas TV assinatura, pesquisas TV cabo, pesquisa TV assinatura, pesquisa TV cabo, indicadores TV assinatura, indicadores TV cabo, evolução TV assinatura, evolução TV cabo, faturamento TV assinatura, faturamento TV cabo, empregos TV assinatura, empregos TV cabo" />

	<title>Dados Setor | Associação Brasileira de Televisão por Assinatura</title>
...
<body>
		...
		<section id="conteudo">
			...
			<div class="row">
				<div class="col-xs-12">
					<ol class="breadcrumb">
						<li class="active">Dados do Setor</li>
					</ol>
				</div>
			</div>
			...
			<div class="row" id="dados-do-setor">
				<div class="col-xs-12">
					...
					<a href="http://www.anatel.gov.br/hotsites/conheca_Brasil_SATVA/default.asp?nomeCanal=TV%20por%20Assinatura&amp;codigoVisao=$visao.codigo&amp;site=$visao.tipoSite.codigo" target="_blank"><img src="images/decos/img19.jpg" alt="" /></a>
...
<script src="jsGraficos/graficos.js"></script>
<!-- gráficos /-->
